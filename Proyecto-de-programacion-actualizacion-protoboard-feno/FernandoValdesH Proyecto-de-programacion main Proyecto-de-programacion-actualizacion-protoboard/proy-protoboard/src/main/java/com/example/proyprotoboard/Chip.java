...
public class Chip extends Indicador{
    ...
    public void pasarCorrienteAND(protoboard _Protoboard, Chip _chip){
        ...
        if (_chip.posicion2.corriente && _chip.pos_3.corriente && (_chip.posicion2.polaridad == _chip.posicion1.polaridad && _chip.pos_3.polaridad == _chip.posicion1.polaridad)){
            ...
            for (int i = 3 ; i < 8 ; i++){
                ...
                _Protoboard.protoboard[_chip.pos_4.coordenadax][i]._posicion.polaridad = _chip.posicion1.polaridad;
            }
        }
        if (_chip.pos_5.corriente && _chip.pos_6.corriente && (_chip.pos_5.polaridad == _chip.posicion1.polaridad && _chip.pos_6.polaridad == _chip.posicion1.polaridad)){
            ...
            for (int i = 3 ; i < 8 ; i++){
                ...
                _Protoboard.protoboard[_chip.pos_7.coordenadax][i]._posicion.polaridad = _chip.posicion1.polaridad;
            }
        }
        if (_chip.pos_8.corriente && _chip.pos_9.corriente && (_chip.pos_8.polaridad == _chip.posicion1.polaridad && _chip.pos_9.polaridad == _chip.posicion1.polaridad)){
            ...
            for (int i = 9 ; i < 14 ; i++){
                ...
                _Protoboard.protoboard[_chip.pos_10.coordenadax][i]._posicion.polaridad = _chip.posicion1.polaridad;
            }
        }
        if (_chip.pos_11.corriente && _chip.pos_12.corriente && (_chip.pos_11.polaridad == _chip.posicion1.polaridad && _chip.pos_12.polaridad == _chip.posicion1.polaridad)){
            ...
            for (int i = 9 ; i < 14 ; i++){
                ...
                _Protoboard.protoboard[_chip.pos_13.coordenadax][i]._posicion.polaridad = _chip.posicion1.polaridad;
            }
        }}
    }
